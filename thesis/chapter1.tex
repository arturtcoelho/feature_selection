...
In recent years, model interpretability tools have gained prominence, with SHAP (SHapley Additive exPlanations) emerging as a particularly influential framework~\cite{lundberg2020local}. SHAP provides theoretically grounded feature attributions derived from cooperative game theory, offering both local explanations for individual predictions and global importance rankings across datasets~\cite{fryer2021shapley}. While SHAP is primarily designed for post-hoc explanation, its global importance scores can naturally be repurposed for feature selection. This raises a practical question: does SHAP-based selection offer advantages over established methods, or does its explanatory elegance come without corresponding gains in predictive utility?
